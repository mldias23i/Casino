Desafio Técnico - Platform Casino Integration API
 ...
 - Implementação de 2 ou 3 códigos de erro da API
 - Uso da autenticação dos pedidos conforme descrito no documento


Estrutura do Projeto

 O projeto é uma API desenvolvida em Django, que fornece endpoints para realizar várias operações. 
 ...
 betLogic.py - A lógica relacionada com as apostas, separada do ficheiro views.py, para mostrar que há escolha entre implementar tudo no ficheiro views.py ou em vários ficheiros com diferentes classes.
...
Execução do projeto
 ...
 No ficheiro settings.py é possível fazer alterações a algumas configurações, como por exemplo, a base de dados que está a ser utilizada.
 Neste projeto é utilizada uma base de dados PostgreSQL e devem ser alterados os dados de autenticação no ficheiro settings.py.
...
Testes Unitários
  ...
  O projeto inclui testes unitários para as funcionalidades principais. Podem ser executados da seguinte forma:
